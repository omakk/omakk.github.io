...
var resume = '<h2 class="text-center"><u>EDUCATION</u></h2><p class="text-center"><strong>McGill University, Montréal, QC, Canada</strong><p class="text-center">Bachelor of Software Engineering</p><p class="text-center"><i>Sept 2011 - April 2017</i></p><h2 class="text-center"><u>TECHNICAL SKILLS</u></h2><div class="row"><div class="col-md-6 col-sm-12 col-xs-12"><h3 class="text-center">PROGRAMMING LANGUAGES</h3><ul class="text-center list-unstyled content-list"><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li></ul></div><div class="col-md-6 col-sm-12 col-xs-12"><h3 class="text-center">FRAMEWORKS & TOOLS</h3><ul class="text-center list-unstyled content-list"><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li></ul></div></div><h2 class="text-center"><u>PROJECTS</u></h2><a href="javascript:$(\'#projects-btn\').click()" role="button"><p class="text-center">Over here!</p></a><h2 class="text-center"><u>WORK EXPERIENCE</u></h2><ul class="text-center list-unstyled content-list"><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li></ul><h2 class="text-center"><u>LANGUAGES</u></h2><ul class="text-center list-unstyled content-list"><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li><li class="content-list-item">blah</li></ul>'
